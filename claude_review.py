...
def send_to_claude(files_content):
    ...
    prompt = """Please review the following code for bugs. If you don't see any bugs, say it looks fine. If you do see bugs, provide an excerpt of the code, along with the file it comes from, and say what you think the problem is.

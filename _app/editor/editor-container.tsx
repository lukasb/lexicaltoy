...
function EditorContainer({
  ...
  return (
    <div className="flex flex-col items-start md:mb-4">
      <div className={`relative border-solid shadow-md dark:shadow-gray-500/50 md:shadow-none md:border-4 md:rounded-lg m-0 pt-2 pr-2.5 md:pr-7 ${backlinks.length > 0 ? 'pb-4' : 'pb-7'} pl-0 w-full max-w-7xl ${
